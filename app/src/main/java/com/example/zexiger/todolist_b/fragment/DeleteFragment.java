package com.example.zexiger.todolist_b.fragment;
...
import com.example.zexiger.todolist_b.activities.MainActivity_2_1;
import com.example.zexiger.todolist_b.activities.MainActivity_2_2;
import com.example.zexiger.todolist_b.recyclerview_3.ItemInit_2;
        ...
        button_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(activity_str.equals("MainActivity")){
                    ...
                    Log.d("ttttt","DeleteFragment,无匹配的activity");
                }
                /*
